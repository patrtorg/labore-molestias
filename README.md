...
[![CI](https://github.com/patrtorg/labore-molestias/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/patrtorg/labore-molestias/actions)
[![NPM ver](https://img.shields.io/npm/v/@patrtorg/labore-molestias?color=33cd56&logo=npm)](https://www.npmjs.com/package/@patrtorg/labore-molestias)
[![install size](https://packagephobia.com/badge?p=@patrtorg/labore-molestias)](https://packagephobia.com/result?p=@patrtorg/labore-molestias)
[![deps](https://img.shields.io/librariesio/release/npm/@patrtorg/labore-molestias)](https://libraries.io/npm/@patrtorg/labore-molestias)
![LoC](https://tokei.rs/b1/github/gnabgib/@patrtorg/labore-molestias-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@patrtorg/labore-molestias) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@patrtorg/labore-molestias-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@patrtorg/labore-molestias). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @patrtorg/labore-molestias --ignore-scripts
```
